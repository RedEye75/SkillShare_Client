      ...
      <div className="grid mb-5 space-y-4   lg:grid-cols-3 px-28 md:grid-cols-2 sm:grid-cols-1 gap-11">
        <details class="group border-l-4 border-green-500 bg-gray-50 p-6">
          ...
          <p class="mt-4 leading-relaxed text-gray-700">
            ...
            your chance to explain that to people. Point out that there are
            different types of online courses and programs, and that they’ll
            have to decide which is best for them. Then, explain the types of
            courses you offer and how your online programs work to give them all
            the information they need. This not only gives them information, but
            it increases their trust because you’re being transparent and giving
        ...
        <details class="group border-l-4 border-green-500 bg-gray-50 p-6">
          ...
          <p class="mt-4 leading-relaxed text-gray-700">
            ...
            of busy people that want to better themselves, so the self-paced
            programs are popular. Whether or not you provide this option, be
            sure to answer this question for people and explain the pros and
            cons of each type of learning. As a bonus, you can even invite them
            to contact you for more information or to discuss what their options
            are.
          </p>
        </details>
